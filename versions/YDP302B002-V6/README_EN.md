...
| ESP32-S3 · AXS15231B QSPI + hardware rotate 90° (560×170) | [`examples/hw-rotate-90/esp32s3-3.02-tft-170x560-qspi-axs15231b-bringup/`](./examples/hw-rotate-90/esp32s3-3.02-tft-170x560-qspi-axs15231b-bringup/) |

## Repository layout

```text
3.02-tft-170x560-qspi-axs15231b/                                # repo root (nav: ../../README_EN.md)
└── versions/
    └── YDP302B002-V6/                                # full materials for this part number
        ├── README.md
        ├── README_EN.md
        ├── images/
        ├── docs/
...
- [ESP32-S3 AXS15231B QSPI + hardware rotate 90°](./examples/hw-rotate-90/esp32s3-3.02-tft-170x560-qspi-axs15231b-bringup/)
